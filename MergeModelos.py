...
# Configura a câmera para resolução mais baixa
...
# Função para capturar a câmera em tempo real e classificar emoções e gestos
def classify_realtime():
    frame_count = 0
    skip_frames = 2  # Número de frames a ignorar
